  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51HDuSqBK2SfRsc62w3uSr6ATOns8ADARRSXiplh3AAx4KcVuY2jHTU5SG7n0toD0zVrfqfxWy02hbJsEbwBCWrhf004Cky8QjH');
            _context.prev = 1;
            _context.next = 4;
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // New form data for files upload
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // Get Tout ID from dataset

    (0, _stripe.bookTour)(tourId); // Call function to process payment
  });
}
